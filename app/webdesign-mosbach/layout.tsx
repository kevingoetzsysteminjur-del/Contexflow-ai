...
export const metadata: Metadata = {
  ...
  description:
    "Professionelles Webdesign in Mosbach. Kevin Götz (Contexflow AI) baut schnelle Next.js Websites & KI-Lösungen für Unternehmen im Neckar-Odenwald-Kreis. Festpreis ab 1.000€.",
};
